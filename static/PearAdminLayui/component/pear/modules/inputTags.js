...
layui.define(['jquery','layer'],function(exports){
  ...
  Class.prototype.init = function(){
    ...
    spantext = $(span).text("确定").addClass('albtn'),
    btntext = $(btn).text("取消").addClass('cancelbtn')
    var span1 = '<span class="albtn" lay-filter="formbtn" lay-submit>确定</span>'
    // var span2 = '<span class="cancelbtn">取消</span>'
    if(options.aldaBtn){
      $('body').append(span1);
      // $('body').append(span2)
    }
...
}).link('/static/PearAdminLayui/component/pear/css/pear-module/inputTags.css')
