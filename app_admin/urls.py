...
urlpatterns = [
    ...
    path('admin_plant_manage/',views.admin_plant_manage,name="admin_plant_manage"), # 发布平台管理
    path('drawing_bed_setting/',views.drawing_bed_setting,name="drawing_bed_setting"), # 发布平台管理
    # path('admin_cookie_manage/',views.admin_cookie_manage,name="admin_cookie_manage"), # 发布平台 cookie 管理
