...
from app_doc import views, views_user, views_search, util_upload_img, views_import, views_doc_pub
...
urlpatterns = [
    ...
    # path('manage_doc_publish/',views.manage_doc_publish,name="manage_doc_publish"), # 管理已分发文档
    ...
    path('del_bottom/', views_user.del_bottom, name="del_bottom"),  # 删除底部模板
]
